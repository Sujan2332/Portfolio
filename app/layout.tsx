...
const TITLE = 'Sai Sujan S — Full Stack Developer';
const DESCRIPTION =
  'Sai Sujan S is a full-stack developer building fast, accessible, and conversion-focused digital products with React, Next.js, Node.js, and e-commerce expertise.';
