                    ...
                    <div className="space-y-5">
                      {visibleProjects.map((project, i) => (
                        <div key={i} className="relative pl-7">
                          {/* Node dot */}
                          <div
                            className={`absolute left-0 top-1.5 w-3.5 h-3.5 rounded-full border-2 bg-[#0a0a0f] flex items-center justify-center ${
                              project.ongoing ? 'border-green-500' : 'border-blue-500'
                            }`}
                          >
                          ...
                          <div className="rounded-xl p-4 bg-white/[0.02] border border-white/5 transition-all duration-300 hover:-translate-y-0.5 hover:border-blue-500/20 hover:shadow-[0_8px_30px_rgba(0,0,0,0.25)]">
                            ...
                            <div className="flex flex-wrap items-center gap-2 mb-2">
                              ...
                              {project.tag && (
                                <span
                                  className={`px-2 py-0.5 text-[0.65rem] font-medium rounded-full border ${
                                    project.ongoing
